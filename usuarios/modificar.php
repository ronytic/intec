    	...
    	<div class="prefix_3 grid_4 suffix_3">
			<fieldset>
				...
				<table class="tablareg">
                    ...
                    <tr>
                        <td><?php campos("Celular","celular","text",$usu['celular'],0,array("size"=>30));?></td>
                    </tr>
                    <tr>
                        <td><?php campos("Sexo","sexo","select",array("0"=>"Femenino","1"=>"Masculino"),0,"",$usu['sexo']);?></td>
                        <td><?php campos("Fecha Nacimiento","fechanac","date",$usu['fechanac']);?></td>
                    </tr>
                    <tr>
						<td><?php campos("Email","email","text",$usu['email'],0,array("size"=>30));?></td>
						<td><?php campos("Nivel","nivel","select",array("2"=>"Dirección","3"=>"Profesor","4"=>"Secretaria"),"","",$usu['nivel']);?></td>
					</tr>
					<tr>
